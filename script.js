...
const account1 = {
  ...
  movementsDates: [
    '2022-08-28T21:31:17.178Z',
    '2022-09-02T07:42:02.383Z',
...
const account2 = {
  ...
  movementsDates: [
    ...
    '2022-09-01T16:33:06.386Z',
    '2020-04-10T14:43:26.374Z',
    '2022-08-29T18:49:59.371Z',
    '2022-09-03T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const formatDates = (dt, locale) => {
  let date = new Date(dt);
  let now = new Date();
  let daysPassed = Math.floor((now - date) / (1000 * 60 * 60 * 24));
...
const displayMovements = function (account, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    <div class="movements__date">${formatDates(
